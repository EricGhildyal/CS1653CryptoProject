...
public interface GroupClientInterface
{
     ...
     *
     */
    public TokenTuple getToken(final String username, final String password);
     ...
     *
     */
    public boolean createUser(final String username, final String password, final TokenTuple tokTuple);
     ...
     *
     */
    public boolean deleteUser(final String username, final TokenTuple tokTuple);
     ...
     *
     */
    public boolean createGroup(final String groupname, final TokenTuple tokTuple);
     ...
     *
     */
    public boolean deleteGroup(final String groupname, final TokenTuple tokTuple);
     ...
     *
     */
    public boolean addUserToGroup(final String user, final String group, final TokenTuple tokTuple);
     ...
     *
     */
    public boolean deleteUserFromGroup(final String user, final String group, final TokenTuple tokTuple);
     ...
     *         an error.
     */
    public List<String> listMembers(final String group, final TokenTuple tokTuple);
